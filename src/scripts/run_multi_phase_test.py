...
def main():
    print("Starting multi-phase anomaly detection test...")

    os.chdir("/home/atharva20240519/prmon/build/package")

    phase1_cmd = ["./tests/burner", "--threads", "2", "--time", "300"]
    ...
    phase7_cmd = ["./tests/burner", "--threads", "2", "--time", "360"]
    ...
    combined_filename = "prmon_combined_dataset_allthree.json"
    ...
    timeseries_filename = "prmon_combined_timeseries_allthree.json"
